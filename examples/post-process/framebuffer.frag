...
{
    vec3 final_color;
    if (post_process_id == 0)
        final_color = pp_inverse();
    else if (post_process_id == 1)
        final_color = pp_gray();
    else if (post_process_id == 2)
        final_color = pp_sharpe1();
    else if (post_process_id == 3)
        final_color = pp_sharpe2();
    else if (post_process_id == 4)
        final_color = pp_blur();
    else if (post_process_id == 5)
        final_color = pp_edge_detect();
    else if (post_process_id == 6)
